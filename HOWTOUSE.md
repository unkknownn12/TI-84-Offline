...
You can either:
- **Type a problem directly** — the router detects the type automatically
...
immediately after. The main file `math_ai.py` acts as a lightweight router that 
detects the problem type from your input and loads the correct solver on demand.
